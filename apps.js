export function getAppDirectories() {
  return [
    ...
    { name: "门店笔记", path: "academy/index.html#/apps/notes", icon: "academy/pages/notes/icon.svg", fallback: "笔" },
    { name: "今岭流水可视化", path: "jlksh/index.html", icon: "jlksh/icon.svg", fallback: "流" },
    { name: "今岭后厨订货", path: "academy/index.html#/apps/jlhcdh", icon: "academy/pages/jlhcdh/icon.svg", fallback: "订" },
