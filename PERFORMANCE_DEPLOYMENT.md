...
SQL、文档、测试、依赖清单、开发脚本、原始流水数据，以及 `apps/academy/pages/jlhcdh/add_frontdesk_products.html`、`apps/academy/pages/jlhcdh/update_tags.html` 两个维护页面不发布。维护页面仍保留在仓库，必要时通过本地开发服务使用。构建脚本不会扫描目录自动公开新文件。
